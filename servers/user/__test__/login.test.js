...
describe("post login customer", () => {
  it("post /customers/login => success test status(200)", async () => {
    const payload = {
      email: `lordfeexz3@gmail.com`,
      password: `qwertyui`,
    };
    const result = await request(app).post("/customers/login").send(payload);
...
describe("post login customer", () => {
  it("post /customers/login => fail test status(401)", async () => {
    const payload = {
      email: `lordfeexz3@gmail.com`,
      password: `qwe`,
    };
